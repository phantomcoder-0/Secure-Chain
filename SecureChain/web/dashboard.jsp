...
<body>
            ...
            <div class="user-menu">
                <div class="user-info">
                    ...
                    <div>
                        ...
                        <div style="font-size: 0.9rem; color: #6b7280;">Authenticated User Session Lifecycle</div>
                    </div>
                </div>
    ...
    <main class="main-content">
        ...
        <div id="dashboard" class="content-section active">
            ...
            <div class="stats-grid">
                ...
                <!-- START: Modified Card -->
                <div class="stat-card" id="hashing-info-card" onclick="openModal('sha256Modal')">
                    <div class="stat-header">
    ...
    <!-- START: Added Modal HTML -->
    <div id="sha256Modal" class="modal">
        <div class="modal-content">
            <span class="close-btn" onclick="closeModal('sha256Modal')">×</span>
            <h2>What is SHA-256?</h2>
            <p>SHA-256 (Secure Hash Algorithm 256-bit) is a cryptographic hash function. It takes any input (like a file) and produces a fixed-size 256-bit (64-character hexadecimal) string known as a "hash" or "digest". This hash is a unique digital fingerprint of the data.</p>
            <h3>Key Characteristics:</h3>
            <ul>
                <li><strong>Deterministic:</strong> The same file will always produce the exact same SHA-256 hash.</li>
                <li><strong>One-Way Function:</strong> It is computationally impossible to reverse the process and get the original file from its hash.</li>
                <li><strong>Avalanche Effect:</strong> Changing even a single bit in the file will result in a completely different and unpredictable hash.</li>
                <li><strong>Collision Resistant:</strong> It's virtually impossible to find two different files that produce the same hash.</li>
            </ul>
            <h3>Why is it used in SecureChain?</h3>
            <p>We use SHA-256 to guarantee the integrity of your evidence. When you upload a file, we calculate its hash and store it securely. To verify the file later, we simply recalculate the hash of the current file and compare it to the original, stored hash. If they match, it proves the file has not been altered, tampered with, or corrupted in any way. This provides a robust and mathematically certain method for maintaining the chain of custody for digital evidence.</p>
        </div>
    </div>
